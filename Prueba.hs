...
--personaConMasAmigos [(a,b)] = [a,b]
--personaConMasAmigos ((a,b):xs) | 

--contadorPersonas :: String -> [String] -> Integer
--contadorPersonas _ [x] = 1



--pertenece :: String -> [String] -> Bool
--pertenece persona [x] = persona == x
--pertenece persona (x:xs) | persona /= x = pertenece persona xs
--                         | otherwise = False
